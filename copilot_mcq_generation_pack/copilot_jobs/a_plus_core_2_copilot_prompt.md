# Copilot MCQ generation job — CompTIA A+ Core 2 220-1202

Use this file with `../topics/a_plus_core_2_topics.json` and `../schema/mcq_question.schema.json`.

## Goal

Generate **3 hard or expert MCQs per topic** for CompTIA A+ Core 2 220-1202.
...
Use every topic in `../topics/a_plus_core_2_topics.json`.
