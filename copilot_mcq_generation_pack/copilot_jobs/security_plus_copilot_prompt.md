# Copilot MCQ generation job — CompTIA Security+ SY0-701

Use this file with `../topics/security_plus_topics.json` and `../schema/mcq_question.schema.json`.

## Goal

Generate **3 hard or expert MCQs per topic** for CompTIA Security+ SY0-701.
...
Use every topic in `../topics/security_plus_topics.json`.
