# Copilot MCQ generation job — CompTIA A+ Core 1 220-1201

Use this file with `../topics/a_plus_core_1_topics.json` and `../schema/mcq_question.schema.json`.

## Goal

Generate **3 hard or expert MCQs per topic** for CompTIA A+ Core 1 220-1201.
...
Use every topic in `../topics/a_plus_core_1_topics.json`.
